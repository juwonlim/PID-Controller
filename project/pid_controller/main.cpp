...
/* 
// iteration #8
static const double KP_STEER = 0.32; // 차선 변경 속도 증가
static const double KI_STEER = 0.0006; // 기존유지
static const double KD_STEER = 0.1;  // 조향값 튀는 현상 추가 완화  

static const double MAX_STEER = 0.8;  // 조향 제한값 완화   
static const double MIN_STEER = -0.8; 

//가속 반응속도 개선
static const double KP_THROTTLE = 0.2; // 가속 반응 증가  
static const double KI_THROTTLE = 0.0007;  // 기존 유지  
static const double KD_THROTTLE = 0.05;  // 급격한 속도 변화 완충
...
/*
// iteration #9
static const double KP_STEER = 0.32; 
static const double KI_STEER = 0.001067; //(KP_STEER의 0.003333배)
static const double KD_STEER = 0.32; //(KP_STEER의 1배)

static const double MAX_STEER = 1.28;  // 1.28 (KP_STEER의 4배)
static const double MIN_STEER = -1.28; 

//가속 반응속도 개선
static const double KP_THROTTLE = 0.2; // 가속 반응 증가  
static const double KI_THROTTLE = 0.0009; //(KP_THROTTLE의 0.0045배)
static const double KD_THROTTLE = 0.1;  // KP_THROTTLE의 0.5배)
...
//iteration #10
static const double KP_STEER = 0.28; 
static const double KI_STEER = 0.000933; // (KP_STEER의 0.003333배)
static const double KD_STEER = 0.28; // (KP_STEER의 1배)

static const double MAX_STEER = 1.12;  // (KP_STEER의 4배)
static const double MIN_STEER = -1.12; 
